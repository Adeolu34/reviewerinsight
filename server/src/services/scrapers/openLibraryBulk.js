...
// ~100 subjects × 5 pages × 100 results = up to 50,000 candidates per run
const SUBJECTS = [
  // Fiction
  ...
  // Classic & rare fiction
  { term: 'classic+literature',       genre: 'Fiction' },
  { term: 'victorian+literature',     genre: 'Fiction' },
  { term: '19th+century+fiction',     genre: 'Fiction' },
  { term: 'modernist+literature',     genre: 'Fiction' },
  { term: 'postcolonial+fiction',     genre: 'Fiction' },
  { term: 'african+literature',       genre: 'Fiction' },
  { term: 'latin+american+fiction',   genre: 'Fiction' },
  { term: 'asian+literature',         genre: 'Fiction' },
  { term: 'gothic+fiction',           genre: 'Fiction' },
  { term: 'magical+realism',          genre: 'Fiction' },
  // Sci-Fi / Fantasy
  ...
  { term: 'cyberpunk',                genre: 'Sci-Fi' },
  { term: 'hard+science+fiction',     genre: 'Sci-Fi' },
  // Memoir / Biography
  { term: 'memoir',                   genre: 'Memoir' },
  { term: 'autobiography',            genre: 'Memoir' },
  { term: 'biography',                genre: 'Memoir' },
  { term: 'personal+narrative',       genre: 'Memoir' },
  { term: 'political+biography',      genre: 'Memoir' },
  { term: 'celebrity+memoir',         genre: 'Memoir' },
  { term: 'scientific+biography',     genre: 'Memoir' },
  { term: 'literary+biography',       genre: 'Memoir' },
  { term: 'sports+biography',         genre: 'Memoir' },
  { term: 'music+biography',          genre: 'Memoir' },
  { term: 'artist+biography',         genre: 'Memoir' },
  { term: 'military+biography',       genre: 'Memoir' },
  { term: 'presidential+biography',   genre: 'Memoir' },
  { term: 'business+biography',       genre: 'Memoir' },
  { term: 'historical+biography',     genre: 'Memoir' },
  { term: 'african+american+biography',genre: 'Memoir' },
  // Essays / Nonfiction
  ...
  { term: 'ancient+philosophy',       genre: 'Essays' },
  { term: 'folklore+mythology',       genre: 'Essays' },
  // History
  ...
  { term: 'asian+history',            genre: 'History' },
  { term: 'colonial+history',         genre: 'History' },
  { term: 'african+american+history', genre: 'History' },
  { term: 'political+history',        genre: 'History' },
  { term: 'womens+history',           genre: 'History' },
  { term: 'cold+war',                 genre: 'History' },
  { term: 'world+war',                genre: 'History' },
  { term: 'medieval+history',         genre: 'History' },
  { term: 'latin+american+history',   genre: 'History' },
  { term: 'archaeology',              genre: 'History' },
  // Business
  ...
  { term: 'investing',                genre: 'Business' },
  { term: 'marketing',                genre: 'Business' },
  // Nature / Science
  ...
  { term: 'astronomy',                genre: 'Nature' },
  { term: 'climate+change',           genre: 'Nature' },
  { term: 'medicine',                 genre: 'Nature' },
  // Spiritual / Religious (new)
  { term: 'religion',                 genre: 'Spiritual' },
  { term: 'spirituality',             genre: 'Spiritual' },
  { term: 'theology',                 genre: 'Spiritual' },
  { term: 'buddhism',                 genre: 'Spiritual' },
  { term: 'christianity',             genre: 'Spiritual' },
  { term: 'islam',                    genre: 'Spiritual' },
  { term: 'hinduism',                 genre: 'Spiritual' },
  { term: 'judaism',                  genre: 'Spiritual' },
  { term: 'mysticism',                genre: 'Spiritual' },
  { term: 'meditation',               genre: 'Spiritual' },
  { term: 'philosophy+of+religion',   genre: 'Spiritual' },
  { term: 'sacred+texts',             genre: 'Spiritual' },
  { term: 'occult',                   genre: 'Spiritual' },
  { term: 'new+age',                  genre: 'Spiritual' },
  { term: 'sufism',                   genre: 'Spiritual' },
  { term: 'indigenous+spirituality',  genre: 'Spiritual' },
];
